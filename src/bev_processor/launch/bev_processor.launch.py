...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_single_boundary_side_lock_enabled", "true", bool),
        ("lane_single_boundary_side_pair_confirmation_frames", "2", int),
        ("lane_single_boundary_side_lock_reset_frames", "30", int),
