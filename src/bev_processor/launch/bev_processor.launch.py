...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_seed_sliding_window_initial_width_px", "9", int),
        ("lane_seed_sliding_window_initial_height_px", "12", int),
        ("lane_seed_sliding_window_growth_ratio", "1.08", float),
        ("lane_seed_sliding_window_maximum_width_px", "25", int),
        ("lane_seed_sliding_window_maximum_height_px", "24", int),
        ("lane_seed_sliding_window_step_ratio", "0.65", float),
