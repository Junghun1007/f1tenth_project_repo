...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_centerline_nominal_lane_width_px", "62.0", float),
        ("lane_centerline_width_update_gain", "0.10", float),
        ("lane_centerline_resample_spacing_px", "2.0", float),
        (
        ...
        ("lane_centerline_fit_straight_maximum_heading_deg", "4.0", float),
        ("lane_centerline_fit_maximum_residual_px", "5.0", float),
        (
        ...
        ("lane_centerline_fit_hermite_tangent_scale", "0.75", float),
        ("lane_centerline_outlier_distance_px", "4.0", float),
        ("lane_centerline_transition_frames", "4", int),
        ("lane_centerline_maximum_lateral_jump_px", "3.0", float),
        ("lane_centerline_maximum_heading_jump_deg", "5.0", float),
