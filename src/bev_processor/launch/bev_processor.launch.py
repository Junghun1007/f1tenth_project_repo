...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_centerline_midpoint_smoothing_weight", "0.80", float),
        ("lane_centerline_temporal_current_weight", "0.85", float),
        ("lane_centerline_transition_maximum_correction_m", "0.15", float),
        ("lane_centerline_transition_correction_decay", "0.65", float),
