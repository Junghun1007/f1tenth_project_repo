...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_maximum_extrapolation_m", "0.12", float),
        ...
        ("lane_sliding_window_half_width_far_m", "0.15", float),
        ("lane_sliding_window_measurement_weight", "0.70", float),
        ("lane_sliding_window_heading_weight", "0.35", float),
        ("lane_maximum_tracking_arc_length_m", "3.20", float),
        ("lane_maximum_gap_fill_m", "0.26", float),
        ("lane_measured_point_smoothing_weight", "0.50", float),
