...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_preview_planned_path_enabled", "true", bool),
        (
            "lane_preview_planned_path_topic",
            "/auto/planned_path",
            str,
        ),
        ("lane_preview_planned_path_maximum_age_sec", "0.20", float),
        ("lane_preview_planned_path_thickness_px", "2", int),
