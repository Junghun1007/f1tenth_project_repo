...
def generate_launch_description():
    ...
    lane_parameters = [
        ...
        ("lane_measurement_lateral_gate_far_m", "0.07", float),
        ...
        ("lane_sliding_window_half_width_far_m", "0.10", float),
        ...
        ("lane_measured_point_smoothing_weight", "0.70", float),
        ("lane_minimum_window_pixel_count", "6", int),
        ("lane_expected_width_m", "0.80", float),
        ("lane_width_tolerance_m", "0.10", float),
        ("lane_initial_center_tolerance_m", "0.60", float),
        ("lane_single_initial_tolerance_m", "0.60", float),
        ("lane_maximum_tracking_gap_m", "0.08", float),
        ("lane_minimum_points", "6", int),
        ("lane_allow_single_lane", "true", bool),
        ("lane_infer_partially_missing_lane", "true", bool),
        ("lane_inference_preserve_reference_shape", "true", bool),
        ("lane_inference_tangent_window_m", "0.20", float),
        ("lane_inference_maximum_curvature_per_m", "1.25", float),
        ("lane_inference_maximum_heading_step_deg", "8.0", float),
        ...
        ("lane_temporal_hold_frames", "5", int),
