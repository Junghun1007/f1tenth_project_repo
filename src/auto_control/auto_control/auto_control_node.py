...
class AutoControlNode(Node):
    ...
    def _declare_parameters(self) -> None:
        ...
        self.declare_parameter("maximum_speed_mps", 2.5)
        self.declare_parameter("maximum_lateral_acceleration_mps2", 2.0)
        ...
        self.declare_parameter("minimum_duty", 0.05)
        self.declare_parameter("maximum_duty", 0.07)
